use crate::level::{DataPacks, LevelDat, Version};
...
pub struct AxolotlLevelDat {
    ...
    // This is a relative path to the world folder
...
impl TryFrom<LevelDat> for AxolotlLevelDat {
    ...
    fn try_from(mut value: LevelDat) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            axolotl_version: serde_impl::from_nameless_value(axol_version)?,
